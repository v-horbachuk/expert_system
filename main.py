...
from output import print_transformed_validated_strings, bold_red, print_goals
import read as read
import validate as validate
from exceptions import BadConditionError
from get_strings import pop_bad_strings, \
    validate_initial_fact_strings, \
    validate_query_strings, \
    bicondition_strings_to_rule_strings, \
    extract_facts_from_strings
from strings import string_type_define, RuleString
from facts import Fact, Goal
from equation import Equation
from custom_utils import markings, parse_args
